...
weights = ['Xception.bin.npy', 'DenseNet201.bin.npy', 'InceptionResNetV2.bin.npy', 'VGG16_Places365.bin.npy', 'NASNetLarge.bin.npy',
    'InceptionV3.bin.npy', 'MobileNetV2.bin.npy']

pathsToWeights = ['Xception.bin.npy-113-0.36.hdf5', 'DenseNet201.bin.npy-90-0.36.hdf5', 'InceptionResNetV2.bin.npy-155-0.36.hdf5',
    'VGG16_Places365.bin.npy-147-0.37.hdf5','NASNetLarge.bin.npy-136-0.36.hdf5', 'InceptionV3.bin.npy-170-0.36.hdf5','MobileNetV2.bin.npy-47-0.36.hdf5']
...
np.save('../Results/resultfrom6.bin', res_array)
