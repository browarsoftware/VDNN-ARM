...
import pickle
#file_to_save_res = 'ensemble_results_intersectionOK.txt'
file_to_save_res = 'baseline_results.txt'
...
import numpy as np
result = np.load('../Results/baseline_results.bin.npy')
